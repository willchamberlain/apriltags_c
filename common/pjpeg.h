...
typedef struct pjpeg pjpeg_t;     //// godawful C syntax for "define pjpeg_t as alias for type (struct pjpeg)"  -  see http://fresh2refresh.com/c-programming/c-typedef/  ,  http://stackoverflow.com/a/252810/1200764  ,  note that there is a 'struct name space' parallel to the variable/function name space : see https://stackoverflow.com/a/1675446/1200764
struct pjpeg                      //// reasonable C syntax for a data structure type definition ,  note that there is a 'struct name space' parallel to the variable/function name space : see https://stackoverflow.com/a/1675446/1200764
{
